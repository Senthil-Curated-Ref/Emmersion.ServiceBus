...
namespace EL.ServiceBus.UnitTests
{
    internal class MessageSerializerTests : With_an_automocked<MessageSerializer>
    {
        ...
        public void When_serializing_camel_case_is_used()
        {
            ...
            Assert.That(serialized, Is.EqualTo("{\"intData\":1,\"stringData\":\"hello\",\"temporalData\":\"2020-11-03T01:23:45+00:00\",\"genericData\":[1,2,3]}"));
        }

        [Test]
        public void When_deserializing_casing_is_ignored()
        {
            var json = "{\"intdata\":1,\"StringData\":\"hello\",\"TEMPORALDATA\":\"2020-11-03T01:23:45+00:00\",\"genericData\":[1,2,3]}";
